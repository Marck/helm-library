...
{{- $config := dict
    ...
    "successfulJobsHistoryLimit"   (include "common.intValue" (dict "Config" $b "Key" "successfulJobsHistoryLimit" "Default" 1) | int)
    "failedJobsHistoryLimit"       (include "common.intValue" (dict "Config" $b "Key" "failedJobsHistoryLimit" "Default" 2) | int)
    "backoffLimit"                 (include "common.intValue" (dict "Config" $b "Key" "backoffLimit" "Default" 2) | int)
